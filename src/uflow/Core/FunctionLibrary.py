...
.. seealso:: :meth:`~uflow.Core.NodeBase.NodeBase.createInputPin`
             :meth:`~uflow.Core.NodeBase.NodeBase.createOutputPin`
             :class:`~uflow.Core.PinBase.PinBase`
...
**nodeType**
    ...
    Value of this argument is :class:`~uflow.Core.Common.NodeTypes`. If :attr:`~uflow.Core.Common.NodeTypes.Callable` specified
