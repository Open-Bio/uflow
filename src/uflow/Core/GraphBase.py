...
from uflow.Core.Interfaces import ISerializable
...
class GraphBase(ISerializable):
    ...
    :vartype graphManager: :class:`~uflow.Core.GraphManager.GraphManager`
    ...
    :var _nodes: nodes storage. Dictionary with :class:`uuid.UUID` as key and :class:`~uflow.Core.NodeBase.NodeBase` as value
    :vartype _nodes: :class:`dict`

    :var uid: Unique identifier
    :vartype uid: :class:`uuid.UUID`

    .. py:attribute:: parentGraph

        Returns a reference to parent graph or None if this graph is root
    ...
    .. py:attribute:: category
        ...
        Returns graph category

    .. py:attribute:: pins

        Returns dictionary with :class:`uuid.UUID` as key and :class:`~uflow.Core.PinBase.PinBase` as value
        :rtype: dict
    ...
    def getVars(self):
        ...
        :returns: :class:`uuid.UUID` - :class:`~uflow.Core.NodeBase.NodeBase` dict
        :rtype: :class:`dict`
        """
        return self._vars
    ...
    def createVariable(
        ...
        :type accessLevel: :class:`~uflow.Core.Common.AccessLevel`
    ...
    def killVariable(self, var):
        ...
        :type var: :class:`~uflow.Core.Variable.Variable`
        """
    ...
    def getNodes(self):
        ...
        :rtype: dict(:class:`~uflow.Core.NodeBase.NodeBase`)
        """
        return self._nodes
