...
def cycleCheck(src, dst):
    ...
    :type src: :class:`uflow.Core.PinBase.PinBase`
    :param dst: hand side pin
    :type dst: :class:`uflow.Core.PinBase.PinBase`
...
def arePinsConnected(src, dst):
    ...
    .. note:: Pins can be passed in any order if **src** pin is :py:class:`uflow.Core.Common.PinDirection`, they will be swapped

    :param src: left hand side pin
    :type src: :py:class:`uflow.Core.PinBase.PinBase`
    :param dst: right hand side pin
    :type dst: :py:class:`uflow.Core.PinBase.PinBase`
...
def getConnectedPins(pin):
    ...
    :type pin: :py:class:`uflow.Core.PinBase.PinBase`
    :returns: Set of connected pins
    :rtype: set(:py:class:`uflow.Core.PinBase.PinBase`)
    """
    result = set()
...
def pinAffects(lhs, rhs):
    ...
    :type lhs: :py:class:`uflow.Core.PinBase.PinBase`
    :param rhs: Second Pin to connect
    :type rhs: :py:class:`uflow.Core.PinBase.PinBase`
    """
...
def connectPins(src, dst):
    ...
    * Input value pins can have one output connection if :py:class:`uflow.Core.Common.PinOptions.AllowMultipleConnections` flag is disabled
...
def traverseConstrainedPins(startFrom, callback):
    ...
    Iterates over all constrained chained pins of type :class:`Any <FlowBasePackage.Pins.AnyPin.AnyPin>` and passes pin into callback function. Callback will be executed once for every pin

    :param startFrom: First pin to start Iteration
    :type startFrom: :class:`~uflow.Core.PinBase.PinBase`
    :param callback: Functor to execute in each iterated pin.
    :type callback: callback(:class:`~uflow.Core.PinBase.PinBase`)
    """
...
def push(start_from):
    ...
    :type start_from: :py:class:`~uflow.Core.PinBase.PinBase`
    """
...
def removeDigitsFromEndOfString(string):
    ...
    Similar to :func:`~uflow.Core.Common.extractDigitsFromEndOfString`, but removes digits in the end.
...
class PinOptions(Flag):
    ...
    .. seealso:: :meth:`~uflow.Core.PinBase.PinBase.enableOptions` :meth:`~uflow.Core.PinBase.PinBase.disableOptions`
    """
    ...
    AllowMultipleConnections = auto()  #: This enables pin to allow more than one input connection. See :func:`~uflow.Core.Common.connectPins`

    ChangeTypeOnConnection = auto()  #: Used by :class:`~FlowBasePackage.Pins.AnyPin.AnyPin` to determine if it can change its data type on new connection.
    ...
    AllowAny = auto()  #: Special flag that allow a pin to be :class:`~FlowBasePackage.Pins.AnyPin.AnyPin`, which means non typed without been marked as error. By default, a :py:class:`FlowBasePackage.Pins.AnyPin.AnyPin` need to be initialized with some data type, other defined pin. This flag overrides that. Used in lists and non typed nodes
    DictElementSupported = auto()  #: Dicts are constructed with :class:`DictElement` objects. So dict pins will only allow other dicts until this flag enabled. Used in :class:`~FlowBasePackage.Nodes.makeDict` node
...
def findStructFromValue(value):
    """Finds :class:`~uflow.Core.Common.StructureType` from value

    :param value: input value to find structure.
    :returns: Structure Type for input value
    :rtype: :class:`~uflow.Core.Common.StructureType`
    """
...
class PinSelectionGroup(IntEnum):
    """Used in :meth:`~uflow.Core.NodeBase.NodeBase.getPinSG` for optimization purposes"""
