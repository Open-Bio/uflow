...
from uflow.Core.Interfaces import IItemBase
...
class Variable(IItemBase):
    ...
    :vartype graph: :class:`~uflow.Core.GraphBase.GraphBase`
    """
    ...
    def __init__(
        ...
        :type structure: :attr:`~uflow.Core.Common.StructureType.Single`
    ...
    def location(self):
        ...
        .. seealso:: :meth:`~uflow.Core.GraphBase.GraphBase.location`
        """
    ...
    def accessLevel(self):
        ...
        :rtype: :class:`~uflow.Core.Common.AccessLevel`
        """
