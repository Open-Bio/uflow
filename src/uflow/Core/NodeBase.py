...
from uflow.Core.Interfaces import INode
...
class NodeBase(INode):
    ...
    def setDeprecated(self, message):
        ...
        self._deprecationMessage = (
            "This node will be removed in later releases! {}".format(message)
        )
    ...
    def getMetaData(self):
        ...
        .. seealso:: :mod:`~uflow.Core.FunctionLibrary`
    ...
    def compute(self, *args, **kwargs):
        ...
        .. note:: See :mod:`uflow.Packages.uflowBase.Nodes` source code module for more examples
    ...
    def createInputPin(
        ...
        :type structure: :class:`~uflow.Core.Common.StructureType.Single`
    ...
    def setData(self, pinName, data, pinSelectionGroup=PinSelectionGroup.BothSides):
        ...
        :type pinSelectionGroup: :class:`~uflow.Core.Common.PinSelectionGroup`
        """
    ...
    def getPinSG(self, name, pinsSelectionGroup=PinSelectionGroup.BothSides):
        ...
        :type pinsSelectionGroup: :class:`~uflow.Core.Common.PinSelectionGroup`
