...
from uflow.Core import version
...
class GraphManager(object):
    ...
    def findRootGraph(self):
        ...
        :rtype: :class:`~uflow.Core.GraphBase.GraphBase`
        """
        roots = []
    ...
    def removeGraphByName(self, name):
        """Removes graph by :attr:`~uflow.Core.GraphBase.GraphBase.name`
    ...
    def removeGraph(self, graph):
        ...
        :type graph: :class:`~uflow.Core.GraphBase.GraphBase`
        """
    ...
    def deserialize(self, data):
        ...
        if "fileVersion" in data:
            fileVersion = version.Version.fromString(
                data["fileVersion"]
            )  # TODO: find purpose
        else:
    ...
    def Tick(self, deltaTime):
        """Periodically calls :meth:`~uflow.Core.GraphBase.GraphBase.Tick` on all graphs
    ...
    def findVariableRefs(self, variable):
        ...
        :type variable: :class:`~uflow.Core.Variable.Variable`
        :rtype: list(:class:`~uflow.Core.NodeBase.NodeBase`)
        """
        result = []
    ...
    def findGraph(self, name):
        """Tries to find graph by :attr:`~uflow.Core.GraphBase.GraphBase.name`

        :param name: Name of target graph
        :type name: str
        :rtype: :class:`~uflow.Core.GraphBase.GraphBase` or None
        """
    ...
    def findPinByName(self, pinFullName):
        ...
        :rtype: :class:`~uflow.Core.PinBase.PinBase` or None
        """
        result = None
        for graph in self.getAllGraphs():
    ...
    def findVariableByUid(self, uuid):
        ...
        :rtype: :class:`~uflow.Core.Variable.Variable` or None
        """
        result = None
        for graph in self._graphs.values():
    ...
    def location(self):
        ...
        .. seealso ::
            ...
            :meth:`uflow.Core.GraphBase.GraphBase.location`
        """
    ...
    def getGraphsDict(self):
        ...
        :rtype: dict(str, :class:`~uflow.Core.GraphBase.GraphBase`)
        """
        result = {}
        for graph in self.getAllGraphs():
    ...
    def getAllGraphs(self):
        ...
        :rtype: list(:class:`~uflow.Core.GraphBase.GraphBase`)
        """
    ...
    def getAllVariables(self):
        ...
        :rtype: list(:class:`~uflow.Core.Variable.Variable`)
        """
        result = []
        for graph in self.getAllGraphs():
...
class GraphManagerSingleton(object):
    ...
    def get(self):
        ...
        :rtype: :class:`~uflow.Core.GraphManager.GraphManager`
        """
        return self.man
