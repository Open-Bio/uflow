...
from uflow.UI.Canvas.WatchPinValueItem import WatchItem
            ...
            if pin.direction == PinDirection.Input:
                for wire in pin.uiConnectionList:
                    if expanded:
                        ...
                        wire.destinationPositionOverride = (
                            lambda: self.scenePos()
                            + QtCore.QPointF(0, self.geometry().height())
                        )
