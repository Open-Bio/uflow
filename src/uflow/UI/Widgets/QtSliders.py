...
from uflow.UI.Utils.stylesheet import editableStyleSheet, Colors
from uflow.Core.Common import *
from uflow.Core import structs
...
class uiTick(QtWidgets.QGraphicsWidget):
    ...
    Holds a :obj:`uflow.Core.structs.Tick` inside with U,V attributes and expand it to use colors in V instead of floats for use in gradient sliders"""

    def __init__(self, raw_tick, parent=None):
        """
        :param raw_tick: Input Core Tick
        :type raw_tick: :obj:`uflow.Core.structs.Tick`
...
class pyf_RampSpline(QtWidgets.QGraphicsView):
    """Ui Ramp/Curve Editor that encapsulates a :obj:`uflow.Core.structs.splineRamp` to edit it
    ...
    def __init__(self, raw_ramp, parent=None, bezier=False):
        ...
        :type raw_ramp: :obj:`uflow.Core.structs.splineRamp`
        :param parent: Parent QWidget
        :type parent: QtWidgets.QWidget, optional
    ...
    def updateFromRaw(self):
        """Updates Ui representation of the internal :obj:`uflow.Core.structs.splineRamp`"""
        try:
    ...
    def addItem(self, u=0, v=0, raw_item=None):
        ...
        :param raw_item: Existing :obj:`uflow.Core.structs.Tick` to link with, if none, one new created , defaults to None
        :type raw_item: :obj:`uflow.Core.structs.Tick`, optional
        """
        if raw_item is None:
