from uflow.Tests.TestsBase import *
from uflow.Core.Common import *
from collections import Counter
from uflow.Input import *
import time
...
class TestGeneral(unittest.TestCase):
    ...
    def test_connect_pins_by_indexes(self):
        ...
        mathLib = packages["uflowBase"].GetFunctionLibraries()["MathAbstractLib"]
        defaultLib = packages["uflowBase"].GetFunctionLibraries()["DefaultLib"]
        classNodes = packages["uflowBase"].GetNodeClasses()
    ...
    def test_graph_location(self):
        packages = GET_PACKAGES()
        man = GraphManager()
        subgraphNodeClass = packages["uflowBase"].GetNodeClasses()["compound"]
    ...
    def test_foo_node_ref_set_data(self):
        packages = GET_PACKAGES()
        randomLib = packages["uflowBase"].GetFunctionLibraries()["RandomLib"]
        defaultLib = packages["uflowBase"].GetFunctionLibraries()["DefaultLib"]
        classNodes = packages["uflowBase"].GetNodeClasses()
    ...
    def test_are_pins_connected(self):
        packages = GET_PACKAGES()
        intlib = packages["uflowBase"].GetFunctionLibraries()["MathAbstractLib"]
    ...
    def test_variable_scope(self):
        ...
        packages = GET_PACKAGES()
        subgraphNodeClass = packages["uflowBase"].GetNodeClasses()["compound"]
        varGetterClass = packages["uflowBase"].GetNodeClasses()["getVar"]
        varSetterClass = packages["uflowBase"].GetNodeClasses()["setVar"]
    ...
    def test_kill_variable(self):
        ...
        # create print node
        defaultLib = packages["uflowBase"].GetFunctionLibraries()["DefaultLib"]
        printerInstance = packages["uflowBase"].GetNodeClasses()["consoleOutput"](
            "print"
        )
        man.activeGraph().addNode(printerInstance)
    ...
    def test_subgraph_execs(self):
        ...
        foos = packages["uflowBase"].GetFunctionLibraries()["DefaultLib"].getFunctions()

        printNode1 = packages["uflowBase"].GetNodeClasses()["consoleOutput"]("print")
    ...
    def test_graph_serialization(self):
        man = GraphManager()
        packages = GET_PACKAGES()
        lib = packages["uflowBase"].GetFunctionLibraries()["MathAbstractLib"]
        defaultLib = packages["uflowBase"].GetFunctionLibraries()["DefaultLib"]
        classNodes = packages["uflowBase"].GetNodeClasses()
    ...
    def test_any_pin_speed(self):
        ...
        classNodes = packages["uflowBase"].GetNodeClasses()
        defaultLib = (
            packages["uflowBase"].GetFunctionLibraries()["DefaultLib"].getFunctions()
        )
        arrayLib = (
            packages["uflowBase"].GetFunctionLibraries()["ArrayLib"].getFunctions()
        )
